...
* **Automated-Reporting:** Report generations is done once the AI has verified the Before and After pictures. Every scan generates a time-stamped, unalterable log.
...
## 🚀 Getting Started
1. Clone the repo: `git clone https://github.com/alex-coder-bot/Vayu-Rakshak-Sutra.git`
